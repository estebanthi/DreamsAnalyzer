...
class Ui_DreamsAnalyzer(object):
    def setupUi(self, DreamsAnalyzer):
        ...
        self.totalDreamsCounter.setMaximum(9999999)
        ...
        self.normalDreamsCounter.setMaximum(9999999)
        ...
        self.lucidDreamsCounter.setMaximum(9999999)
        ...
        self.hhCounter.setMaximum(9999999)
        ...
        self.lucidDreamsRate.setMaximum(9999999.0)
        ...
        self.scrollAreaWidgetContents_7.setGeometry(QtCore.QRect(0, 0, 871, 280))
        self.scrollAreaWidgetContents_7.setObjectName("scrollAreaWidgetContents_7")
        self.barChartsLayout = QtWidgets.QVBoxLayout(self.scrollAreaWidgetContents_7)
        self.barChartsLayout.setObjectName("barChartsLayout")
        self.scrollArea_9.setWidget(self.scrollAreaWidgetContents_7)
        self.verticalLayout_8.addWidget(self.scrollArea_9)
        ...
        self.scrollAreaWidgetContents_5.setGeometry(QtCore.QRect(0, 0, 871, 279))
        self.scrollAreaWidgetContents_5.setObjectName("scrollAreaWidgetContents_5")
        self.pieChartsLayout = QtWidgets.QHBoxLayout(self.scrollAreaWidgetContents_5)
        self.pieChartsLayout.setObjectName("pieChartsLayout")
        ...
        self.emailDMInput = QtWidgets.QLineEdit(self.groupBox_10)
        ...
        self.passwordDMInput = QtWidgets.QLineEdit(self.groupBox_10)
        ...
        self.autosyncCheckBox = QtWidgets.QCheckBox(self.groupBox_10)
        self.autosyncCheckBox.setObjectName("autosyncCheckBox")
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.LabelRole, self.autosyncCheckBox)
        ...
        self.addGraphButton = QtWidgets.QPushButton(self.tab_8)
        self.addGraphButton.setObjectName("addGraphButton")
        self.horizontalLayout_19.addWidget(self.addGraphButton)
        ...
        self.customChartsScroll = QtWidgets.QScrollArea(self.tab_8)
        ...
        self.customChartsScroll.setWidget(self.customCharts)
        self.verticalLayout_13.addWidget(self.customChartsScroll)
        ...
        self.addMetaButton = QtWidgets.QPushButton(self.tab_7)
        self.addMetaButton.setObjectName("addMetaButton")
        self.horizontalLayout_20.addWidget(self.addMetaButton)
        ...
        self.scrollArea_8 = QtWidgets.QScrollArea(self.tab_7)
        self.scrollArea_8.setWidgetResizable(True)
        self.scrollArea_8.setObjectName("scrollArea_8")
        self.scrollAreaWidgetContents_6 = QtWidgets.QWidget()
        self.scrollAreaWidgetContents_6.setGeometry(QtCore.QRect(0, 0, 867, 147))
        self.scrollAreaWidgetContents_6.setObjectName("scrollAreaWidgetContents_6")
        self.metadatasLayout = QtWidgets.QVBoxLayout(self.scrollAreaWidgetContents_6)
        self.metadatasLayout.setObjectName("metadatasLayout")
        ...
        self.dataPathnameEdit = QtWidgets.QLineEdit(self.groupBox_13)
        self.dataPathnameEdit.setObjectName("dataPathnameEdit")
        self.horizontalLayout_21.addWidget(self.dataPathnameEdit)
        self.modifyDataPathname = QtWidgets.QPushButton(self.groupBox_13)
        self.modifyDataPathname.setObjectName("modifyDataPathname")
        self.horizontalLayout_21.addWidget(self.modifyDataPathname)
    ...
    def retranslateUi(self, DreamsAnalyzer):
        ...
        self.groupBox_9.setTitle(_translate("DreamsAnalyzer", "Barres"))
        self.otherPlotsLayout.setTitle(_translate("DreamsAnalyzer", "Camemberts"))
        ...
        self.groupBox_10.setTitle(_translate("DreamsAnalyzer", "Dream Manager"))
        ...
        self.tabWidget_2.setTabText(self.tabWidget_2.indexOf(self.tab_6), _translate("DreamsAnalyzer", "Général"))
        self.addGraphButton.setText(_translate("DreamsAnalyzer", "Ajouter"))
        self.tabWidget_2.setTabText(self.tabWidget_2.indexOf(self.tab_8), _translate("DreamsAnalyzer", "Graphiques personnalisés"))
        self.label_23.setText(_translate("DreamsAnalyzer", "Toute modification sur les métadonnées sera effective au prochain démarrage du logiciel."))
        self.label_26.setText(_translate("DreamsAnalyzer", "Attention, une modification des métadonnées de base peut entraîner des bugs."))
        self.addMetaButton.setText(_translate("DreamsAnalyzer", "Ajouter"))
        self.tabWidget_2.setTabText(self.tabWidget_2.indexOf(self.tab_7), _translate("DreamsAnalyzer", "Métadonnées"))
        self.groupBox_13.setTitle(_translate("DreamsAnalyzer", "Config"))
        self.label_24.setText(_translate("DreamsAnalyzer", "Chemin des données de l\'app"))
        self.modifyDataPathname.setText(_translate("DreamsAnalyzer", "Modifier"))
