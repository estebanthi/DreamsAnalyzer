...
class CustomChartPopup(QMainWindow, Ui_MainWindow):
    ...
    def __init__(self, controller, chart=None, parent=None):
        ...
        self.addTagButton.clicked.connect(lambda x: self.tagsLayout.addWidget(CustomChartTagWidget(self, self.controller)))
    ...
    def get_graph(self):
        ...
        return {'id_': id_, 'title': title, 'tags': tags}
    ...
    def addCategory(self, category):
        ...
        for tag in filtered_tags:
            self.tagsLayout.addWidget(CustomChartTagWidget(self, self.controller, [tag, 'IN', "#"+''.join([random.choice('ABCDEF0123456789') for i in range(6)]), {}]))
