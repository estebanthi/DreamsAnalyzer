...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lundiTypes = MplWidget(self.groupBox_9)
        self.lundiTypes.setObjectName("lundiTypes")
        self.horizontalLayout_12.addWidget(self.lundiTypes)
        self.mardiTypes = MplWidget(self.groupBox_9)
        self.mardiTypes.setObjectName("mardiTypes")
        self.horizontalLayout_12.addWidget(self.mardiTypes)
        self.mercrediTypes = MplWidget(self.groupBox_9)
        self.mercrediTypes.setObjectName("mercrediTypes")
        self.horizontalLayout_12.addWidget(self.mercrediTypes)
        self.jeudiTypes = MplWidget(self.groupBox_9)
        self.jeudiTypes.setObjectName("jeudiTypes")
        self.horizontalLayout_12.addWidget(self.jeudiTypes)
        self.vendrediTypes = MplWidget(self.groupBox_9)
        self.vendrediTypes.setObjectName("vendrediTypes")
        self.horizontalLayout_12.addWidget(self.vendrediTypes)
        self.samediTypes = MplWidget(self.groupBox_9)
        self.samediTypes.setObjectName("samediTypes")
        self.horizontalLayout_12.addWidget(self.samediTypes)
        self.dimancheTypes = MplWidget(self.groupBox_9)
        self.dimancheTypes.setObjectName("dimancheTypes")
        self.horizontalLayout_12.addWidget(self.dimancheTypes)
